...
sono facilmente bloccabili e prevedibili.
I DGA, invece, sono difficili da bloccare e quasi impossibili da prevedere,
...
dai domini legit.
Sono stati analizzati e sperimentati quattro modelli di Machine Learning
per la rilevazione dei DGA, due modelli classici 
basati su tecniche di feature extraction, ovvero le caratteristiche dei domini,
e due basati su tecniche di Deep Learning, ovvero le reti neurali che imparano direttamente dai dati.
I due modelli di Machine Learning basati su feature extraction
sono il Random Forest e l'XGBoost, mentre i due modelli
...
e con un consumo di memoria molto inferiore.
\end{abstract}
...
che vengono poi utilizzati per contattare i server \acrshort{C&C}.
rendendo difficile per i sistemi di protezione bloccarli.
Negli ultimi anni sono stati sviluppati vari metodi di Machine Learning
capaci di rilevare e bloccare i DGA in modo più efficace
rispetto ai metodi tradizionali come le blacklist.
...
ovvero il nome e l'estenzione del dominio.
...
\noindent Inizialmente si è addestrato il modello con la sola 
