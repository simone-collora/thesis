...
\begin{itemize}
    ...
    \item \textbf{Decentralizzati}: In questo tipo di server, i botmaster
    controllano i bot tramite più server. Questo rende più difficile
    bloccare il server ma è anche più complesso da gestire.
...
\begin{figure}
    ...
    \caption{Esempio di server \acrshort{C&C}. (a) centralizzato, (b) decentralizzato (da \cite{6487169})}
