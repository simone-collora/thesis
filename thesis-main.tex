...
si è usato anche il metodo reduce\_lr\_on\_plateau di Keras.
Questo metodo riduce il learning rate appena il modello non migliora più
permettendo al modello di convergere meglio. Nel nostro caso
...
l'addestramento quando il modello non migliora più e per evitare l'overfitting. La patience in questo
