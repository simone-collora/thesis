...
Ad esempio \texttt{atlas.arc.nasa.gov} è il FQDN che porta all'host \texttt{128.102.128.50}\cite{rfc1594}.
...
dallo Stanford Research Institute, che conteneva i nomi di dominio e gli indirizzi IP associati,
