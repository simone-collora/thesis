...
ho deciso di usarle per il progetto sia nella sua forma classica che in quella bidirezionale.
...
Per il training sono state scelte inizialmente 10 epoche.
...
Il modello raggiunge il 99\% di accuracy, 99\% di precision, 99\% di recall e 99\% di F1-Score
...
i domini correttamente. La maggior parte degli errori sono
...
maggiori rispetto alle LSTM classiche, impiegando circa 4 minuti ad epoca e circa 1 ora e 10 minuti in totale.
